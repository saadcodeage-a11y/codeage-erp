...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $defaults = [
            ...
            'Team Manager' => ['read' => true, 'create' => true, 'edit' => true],
        ...
        foreach ($roles as $roleName => $roleId) {
            ...
            DB::table('role_permissions')->updateOrInsert(
                ['role_id' => $roleId, 'module' => 'performance_management'],
                [
    ...
    {
        DB::table('role_permissions')->where('module', 'performance_management')->delete();
    }
};
